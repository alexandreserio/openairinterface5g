...
#define INCREASE_IN_RXGAIN 1 // ALEX (CHANGED from 3 dB to 1 dB step
...
#define MAX_RF_GAIN 76 //ALEX changed to adjust B200 Rx max gain
#define MIN_RF_GAIN 0 //ALEX changed to adjust B200 Rx min gain
